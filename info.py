...
BOT_TOKEN = environ.get('BOT_TOKEN', '7498158728:AAF0HEsetDyF6mWfhaiPAmR5sJ2xK_qbges')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001837694049'))
request_channel = environ.get('REQUEST_CHANNEL', '-1001837694049') # If anyone sends a request message to your bot, you will get it in this channel.
